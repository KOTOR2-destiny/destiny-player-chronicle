(()=>{'use strict';
// Preserve the uploaded map's intrinsic proportions; marker positions refer to its grid.
...
// Pixel coordinates on the 1080 x 1408 map. Odryn stays in N-7, shifted
// north of the grid midpoint into the blue Outer Rim band.
const precise={
'coruscant':[336,604], 'kashyyyk':[673,591], 'sullust':[444,1131],
'dantooine':[340,220], 'odryn':[506,408]
};
